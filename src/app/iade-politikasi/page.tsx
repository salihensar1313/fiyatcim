    ...
    <div className="bg-dark-50 pb-16">
      ...
      <div className="container mx-auto px-4">
        <div className="mx-auto max-w-3xl rounded-xl border border-dark-100 bg-white p-8">
          <h1 className="mb-6 text-2xl font-bold text-dark-900">İade ve Değişim Politikası</h1>
          <div className="space-y-4 text-sm leading-relaxed text-dark-600">
            <h2 className="text-lg font-bold text-dark-900">İade Koşulları</h2>
            <p>Ürünü teslim aldığınız tarihten itibaren 14 gün içinde iade veya değişim talebinde bulunabilirsiniz.</p>
            <h2 className="text-lg font-bold text-dark-900">İade Şartları</h2>
            ...
            <h2 className="text-lg font-bold text-dark-900">İade Süreci</h2>
            ...
            <h2 className="text-lg font-bold text-dark-900">İade Edilemeyecek Ürünler</h2>
