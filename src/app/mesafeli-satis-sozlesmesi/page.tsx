    ...
    <div className="bg-dark-50 pb-16">
      ...
      <div className="container mx-auto px-4">
        <div className="mx-auto max-w-3xl rounded-xl border border-dark-100 bg-white p-8">
          <h1 className="mb-6 text-2xl font-bold text-dark-900">Mesafeli Satis Sozlesmesi</h1>
          <div className="space-y-4 text-sm leading-relaxed text-dark-600">
            <h2 className="text-lg font-bold text-dark-900">Madde 1 - Taraflar</h2>
            <p>
            ...
            <h2 className="text-lg font-bold text-dark-900">Madde 2 - Konu</h2>
            <p>
            ...
            <h2 className="text-lg font-bold text-dark-900">Madde 3 - Sozlesme Konusu Urun Bilgileri</h2>
            <p>
            ...
            <h2 className="text-lg font-bold text-dark-900">Madde 4 - Genel Hukumler</h2>
            ...
            <h2 className="text-lg font-bold text-dark-900">Madde 5 - Teslimat</h2>
            <p>
            ...
            <h2 className="text-lg font-bold text-dark-900">Madde 6 - Cayma Hakki</h2>
            <p>
            ...
            <h2 className="text-lg font-bold text-dark-900">Madde 7 - Cayma Hakkinin Kullanilamayacagi Durumlar</h2>
            <ul className="ml-4 list-disc space-y-1">
            ...
            <h2 className="text-lg font-bold text-dark-900">Madde 8 - Yetkili Mahkeme</h2>
            <p>
            ...
            <p className="mt-6 font-medium text-dark-700">
