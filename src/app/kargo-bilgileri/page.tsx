    ...
    <div className="bg-dark-50 dark:bg-dark-900 pb-16">
      ...
      <div className="container mx-auto px-4">
        <div className="mx-auto max-w-3xl rounded-xl border border-dark-100 bg-white dark:border-dark-700 dark:bg-dark-800 p-8">
          <h1 className="mb-6 text-2xl font-bold text-dark-900 dark:text-dark-50">Kargo Bilgileri</h1>
          <div className="space-y-4 text-sm leading-relaxed text-dark-600 dark:text-dark-300">
            <h2 className="text-lg font-bold text-dark-900 dark:text-dark-50">Kargo Ücreti</h2>
            ...
            <h2 className="text-lg font-bold text-dark-900 dark:text-dark-50">Teslimat Süreleri</h2>
            <ul className="ml-4 list-disc space-y-1">
              <li>İstanbul içi: 1 iş günü</li>
              <li>Diğer iller: 2-3 iş günü</li>
              <li>Doğu Anadolu / Güneydoğu: 3-4 iş günü</li>
            </ul>
            <h2 className="text-lg font-bold text-dark-900 dark:text-dark-50">Kargo Takibi</h2>
