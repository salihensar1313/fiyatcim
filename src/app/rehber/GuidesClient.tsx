      ...
      <div className="mb-8">
        <div className="relative">
          ...
          <input
            ...
            className="w-full rounded-xl border border-dark-200 bg-white py-3 pl-10 pr-4 text-sm focus:border-primary-600 focus:outline-none"
          />
        </div>
      </div>
        ...
        <div className="grid gap-6 sm:grid-cols-2">
          {filtered.map((blog) => (
            <Link
              key={blog.id}
              href={`/blog/${blog.slug}`}
              className="group overflow-hidden rounded-xl border border-dark-100 bg-white transition-shadow hover:shadow-md"
            >
              ...
              <div className="p-5">
                ...
                <h2 className="mb-2 text-lg font-bold text-dark-900 group-hover:text-primary-600">
                  {blog.title}
                </h2>
                <p className="mb-3 line-clamp-2 text-sm text-dark-500">{blog.excerpt}</p>
