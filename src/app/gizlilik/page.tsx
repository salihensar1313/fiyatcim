    ...
    <div className="bg-dark-50 dark:bg-dark-900 pb-16">
      ...
      <div className="container mx-auto px-4">
        <div className="mx-auto max-w-3xl rounded-xl border border-dark-100 bg-white dark:border-dark-700 dark:bg-dark-800 p-8">
          <h1 className="mb-6 text-2xl font-bold text-dark-900 dark:text-dark-50">Gizlilik Politikası</h1>
          <div className="space-y-4 text-sm leading-relaxed text-dark-600 dark:text-dark-300">
            ...
            <h2 className="text-lg font-bold text-dark-900 dark:text-dark-50">Toplanan Bilgiler</h2>
            ...
            <h2 className="text-lg font-bold text-dark-900 dark:text-dark-50">Bilgi Kullanımı</h2>
            ...
            <h2 className="text-lg font-bold text-dark-900 dark:text-dark-50">Bilgi Güvenliği</h2>
            <p>SSL sertifikası ile şifreleme, güvenli sunucu altyapısı ve düzenli güvenlik denetimleri ile verilerinizi koruyoruz.</p>
            <h2 className="text-lg font-bold text-dark-900 dark:text-dark-50">Çerezler</h2>
