    ...
    <div className="bg-dark-50 pb-16">
      ...
      <div className="container mx-auto px-4">
        <div className="mb-8 text-center">
          <h1 className="text-2xl font-bold text-dark-900 md:text-3xl">Hizmetlerimiz</h1>
        ...
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {services.map((service) => (
            <div key={service.title} className="rounded-xl border border-dark-100 bg-white p-6 transition-shadow hover:shadow-md">
              ...
              <p className="mt-2 text-sm leading-relaxed text-dark-600">{service.desc}</p>
            </div>
          ))}
        </div>
        ...
        <div className="mt-12 rounded-xl bg-primary-600 p-8 text-center text-white md:p-12">
          ...
          <Link
            href="/iletisim"
            className="mt-6 inline-block rounded-lg bg-white px-8 py-3 text-sm font-bold text-primary-600 transition-colors hover:bg-dark-50"
          >
            İletişime Geç
          </Link>
        </div>
