    ...
    <div className="bg-dark-50 pb-16">
      ...
      <div className="container mx-auto px-4">
        <div className="mx-auto max-w-3xl rounded-xl border border-dark-100 bg-white p-8">
          <h1 className="mb-6 text-2xl font-bold text-dark-900">On Bilgilendirme Formu</h1>
          <div className="space-y-4 text-sm leading-relaxed text-dark-600">
            ...
            <h2 className="text-lg font-bold text-dark-900">1. Satici Bilgileri</h2>
            <p>
            ...
            <h2 className="text-lg font-bold text-dark-900">2. Urun/Hizmet Bilgileri</h2>
            <p>
            ...
            <h2 className="text-lg font-bold text-dark-900">3. Fiyat Bilgisi</h2>
            <p>
            ...
            <h2 className="text-lg font-bold text-dark-900">4. Odeme Bilgileri</h2>
            <p>
            ...
            <h2 className="text-lg font-bold text-dark-900">5. Teslimat Bilgileri</h2>
            <p>
            ...
            <h2 className="text-lg font-bold text-dark-900">6. Cayma Hakki</h2>
            <p>
            ...
            <h2 className="text-lg font-bold text-dark-900">7. Sikayet ve Itiraz</h2>
            <p>
