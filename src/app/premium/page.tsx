...
import { Crown, Wrench, Headphones, Shield, Zap, Truck, Settings, RefreshCw, Tv, Music, Check, Phone, ArrowRight } from "lucide-react";
...
const ICON_MAP = { Wrench, Headphones, Shield, Zap, Truck, Settings, RefreshCw, Tv, Music };
