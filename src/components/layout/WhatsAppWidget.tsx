...
export default function WhatsAppWidget() {
  ...
  return (
    <div className="fixed bottom-20 right-4 z-50 sm:bottom-6">
      {/* Popup */}
      {showPopup && (
        <div className="mb-3 w-72 overflow-hidden rounded-2xl bg-white dark:bg-dark-800 shadow-2xl ring-1 ring-dark-100">
          {/* Header */}
          <div className="bg-[#075e54] px-4 py-3">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                <div className="flex h-10 w-10 items-center justify-center rounded-full bg-white dark:bg-dark-800/20">
              ...
              <button
                ...
                className="rounded-full p-1 text-white/70 hover:bg-white dark:bg-dark-800/10 hover:text-white"
              >
                <X size={18} />
              </button>
            </div>
          ...
          <div className="bg-[#e5ddd5] px-4 py-4">
            <div className="max-w-[85%] rounded-lg bg-white dark:bg-dark-800 p-3 shadow-sm">
