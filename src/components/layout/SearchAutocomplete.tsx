    ...
    <div className={`relative ${className}`}>
      ...
      <div className="relative">
        ...
        <input
          ...
          className="w-full rounded-lg border border-dark-600 bg-dark-700 py-2.5 pl-10 pr-10 text-sm text-white placeholder-dark-400 outline-none focus:border-primary-500 focus:ring-2 focus:ring-primary-500/20"
          autoComplete="off"
        />
        {query && (
          <button
      ...
      {showDropdown && (
        <div
          ref={dropdownRef}
          className={`absolute left-0 right-0 top-full z-50 mt-1 max-h-[70vh] overflow-y-auto rounded-lg border border-dark-600 bg-dark-800 shadow-xl ${
                    ...
                    {suggestions.products.map((r, i) => (
                      ...
                      >
                        <div className="relative h-10 w-10 flex-shrink-0 overflow-hidden rounded bg-dark-100">
                          <Image
                            src={getProductPrimaryImage(r.product)}
                            alt={r.product.name}
                            fill
                            unoptimized={isRemoteImage(getProductPrimaryImage(r.product))}
